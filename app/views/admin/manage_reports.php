        ...
        'warn_account' => [
            ...
            'actions' => [
                false => [
                    'action' => 'user_warn',
                    'label' => 'Cảnh cáo',
                    'confirm' => 'Gửi cảnh cáo tới tài khoản này?',
    ...
    <div class="rounded-lg border border-slate-200 bg-white overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-sm">
                ...
                <?php if (empty($rows)): ?>
                    <tr>
                        <td colspan="9" class="px-4 py-8 text-center text-slate-500">Chưa có báo cáo phù hợp bộ lọc.</td>
                    </tr>
                <?php else: ?>
