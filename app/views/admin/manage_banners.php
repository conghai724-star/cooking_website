...
$noticeText = match ($notice) {
    'banner_saved' => 'Da luu banner trang chu.',
    'featured_saved' => '�� c?p nh?t c�ng th?c n?i b?t.',
    'today_saved' => '�� c?p nh?t c�ng th?c h�m nay.',
    'banner_save_failed' => 'Luu banner that bai.',
    'featured_save_failed' => 'Luu noi bat that bai.',
    'today_save_failed' => 'Luu c�ng th?c h�m nay th?t b?i.',
    default => '',
};
?>
    ...
    <div class="rounded-xl border border-slate-200 bg-white p-6">
        ...
        <?php if ($recipeOfDay !== null): ?>
            <p class="mt-3 text-sm text-slate-600">
                �ang ch?n cho <?= htmlspecialchars((string) ($recipeOfDay['for_date'] ?? $forDate), ENT_QUOTES, 'UTF-8'); ?>:
