...
<details class="relative">
    ...
    <div class="absolute right-0 z-20 mt-2 w-72 rounded-xl border border-slate-200 bg-white p-3 shadow-lg">
        ...
        <form method="post" action="<?= URLROOT; ?>/comments/<?= $reportCommentId; ?>/report" class="space-y-2" data-ajax-form data-success-toast="<?= htmlspecialchars($reportSuccessToast, ENT_QUOTES, 'UTF-8'); ?>" data-error-toast="<?= htmlspecialchars($reportErrorToast, ENT_QUOTES, 'UTF-8'); ?>" data-success-button-text="Đã gửi báo cáo">
            ...
            <div class="flex justify-end">
                ...
                <button class="rounded-lg border border-red-200 px-3 py-1.5 text-xs font-semibold text-red-600 hover:bg-red-100" type="submit">Gửi báo cáo</button>
